	...
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="index.html" class="logo">
		  ...
		  <div class="logo-lg">
			  ...
			  <span class="dark-logo"><img src="assets\theme\images\logo-light-text.png" alt="logo"></span>
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea class="form-control p-20" name="description" rows="2" placeholder="Description"></textarea>
									</div>
								</div>
							</div>
							<!--/row-->
							<div class="row">
								...
								<div class="col-md-3">
									...
									<div class="product-img text-start">
										...
										<p>Upload Anonther Icon</p>
										<div class="btn btn-info mb-20">
                                            <input type="file" class="upload" name="icone_file"> 
										</div>
							...
							<div class="row">
								<div class="col-md-3">
									...
									<div class="product-img text-start">
										...
										<div class="btn btn-info mb-20">
                                            <input type="file" class="upload" name="background_image"> 
										</div>
										<button class="btn btn-success">Edit</button>
										<button class="btn btn-danger">Delete</button>
									</div>
